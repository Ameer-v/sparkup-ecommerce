          ...
          {user ? (
            <div className="hidden md:flex items-center gap-3">
              ...
              {user.role?.name ===
                ...
                <a
                  href="/admin"
                  className="px-5 h-12 rounded-full bg-purple-600 text-white flex items-center"
                >
              ...
              <div className="px-5 h-12 rounded-full border border-zinc-300 dark:border-zinc-700 flex items-center">
              ...
              <button
                onClick={logout}
                className="px-6 h-12 rounded-full bg-red-500 text-white"
              >
            ...
            <>
              <a
                href="/login"
                className="hidden md:flex px-6 h-12 items-center rounded-full border border-zinc-300 dark:border-zinc-700"
              >
              ...
              <a
                href="/register"
                className="hidden md:flex px-6 h-12 items-center rounded-full bg-black text-white"
              >
